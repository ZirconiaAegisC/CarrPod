# E115 – Nissan North America

**Subject:** AEGIS C-SHIELD: Hardened Electronics for Nissan's Leaf/Ariya EV Platforms & TN/MS Manufacturing
...
GOOOOOOOD MORNING, NISSAN! Aegis C-SHIELD is rolling into Franklin with hardened silicon that honors the legacy of the vehicle that first proved electric cars could be a mass-market reality. The Nissan Leaf — over 600,000 units sold globally since 2010 — was the world's first volume-production electric vehicle, and its battery systems have accumulated more real-world operational hours than any other EV platform in history. That operational history is also the world's largest uncontrolled experiment in terrestrial neutron effects on automotive power electronics: every Leaf on the road has an inverter controller, a battery management system, and an onboard charger whose processors have been silently accumulating soft errors at a rate proportional to their SRAM area, their operating altitude, and the solar cycle. Nissan now builds the Ariya on the CMF-EV platform in Tochigi, Japan — a 300+ mile BEV with a liquid-cooled battery and a sophisticated thermal management system — while operating major manufacturing facilities in Smyrna, Tennessee and Canton, Mississippi that produce over a million vehicles annually. The Ariya's ProPILOT 2.0 hands-off highway driving system places an ASIL-D functional safety requirement on perception and planning processors that cannot be satisfied by silicon whose bit-error rate is stochastic and environmentally driven. Nissan pioneered practical electric mobility; C-SHIELD offers the semiconductor technology to make that mobility immune to the one environmental factor no automotive OEM currently controls: the neutron.
...
**9. Nissan-Specific Personalization**

Nissan occupies a unique position in C-SHIELD's addressable market: you are the only OEM whose EV operational history spans more than a decade at mass-production scale. The Nissan Leaf fleet has accumulated over 10 billion electric miles globally — a dataset that, were it instrumented for soft-error telemetry, would represent the largest empirical study of terrestrial neutron effects on automotive power electronics ever conducted. With the Ariya now ramping on the CMF-EV platform and the Smyrna and Canton plants retooling for next-generation EV production under Nissan Ambition 2030, Nissan has an opportunity to make semiconductor radiation hardness a design-in requirement rather than a post-hoc reliability investigation. The Ariya's liquid-cooled battery management system, operating at pack voltages up to 400V, relies on voltage and temperature sensing ASICs whose measurement accuracy can be corrupted by single-event transients in their analog front-ends. A corrupted cell-voltage reading — even by a few millivolts — can trigger a false overvoltage or undervoltage fault in the BMS, initiating a contactor opening and a propulsion-system shutdown with no root cause detectable by the dealer service tool. C-SHIELD's rad-hard analog front-end and supervisory microcontroller eliminate these silent sensing failures at the physics level. Additionally, Nissan's ProPILOT 2.0 system — with hands-off highway driving capability — places the highest functional safety burden on perception processors of any system currently deployed by a Japanese OEM. We would welcome the opportunity to brief your Nissan Technical Center North America engineering leadership in Farmington Hills, your Smyrna/Canton manufacturing teams, and your global electronics architecture group.
