#!/bin/bash
# ============================================================
# build.sh — No-Gradle APK Build for Land .O Lil v6b
...
echo "============================================================"
echo "  Land .O Lil v6b — No-Gradle Build"
...
echo "[2b] Packaging assets (JS, HTML, Credits)..."
if [ -d "$SRC_DIR/assets" ]; then
    ASSET_COUNT=$(find "$SRC_DIR/assets" -type f | wc -l)
    echo "  Found $ASSET_COUNT asset files"
    # Inject assets into base APK using aapt2 add
