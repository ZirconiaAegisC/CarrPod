#!/bin/bash
# ============================================================
# build.sh — No-Gradle APK Build for Land O Lil v7b
# Pipeline: aapt2 compile → aapt2 link → javac → d8 → zipalign → apksigner
# Pure Java Canvas — no WebView, no HTML assets, no Gradle, no AndroidX
# Identical methodology to v6b CLI build pipeline
# ============================================================
set -e
...
echo "============================================================"
echo "  Land O Lil v7b — No-Gradle Build (Pure Java Canvas)"
...
echo "  No assets directory — pure Java Canvas app — skipping asset injection."
