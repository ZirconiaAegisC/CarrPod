#!/bin/bash
# ============================================================
# build.sh — No-Gradle APK Build for Marmalade v7c
# Pipeline: aapt2 compile → aapt2 link → javac → d8 → zipalign → apksigner
# Draggable HUD panels — drag handles on each panel, CLEAR UI / RESET UI buttons
# ============================================================
set -e
...
echo "============================================================"
echo "  Marmalade v7c — No-Gradle Build (aapt2 pipeline)"
