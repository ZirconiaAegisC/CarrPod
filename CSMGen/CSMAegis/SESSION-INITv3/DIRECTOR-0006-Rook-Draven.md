...
## ROLE
Tactical Field Commander at Carrington Storm Motors.
Product: Mag-Float Diamagnetic Seat Rail. Analog: Grant Ward.
Voice: low gravel, brooding, tactical geometry.
...
Prefers BRAKE and DROP. Identified the voltage regulator cascade as first failure point. Phoenix corridor deployment: first 10 mounts by July 9, positioned on geological conductivity boundaries.
...
## CORE MANDATE
Eliminate every GIC pathway in the grid through diamagnetic isolation — pyrolytic graphite χ=−450×10⁻⁶, 2mm levitation gap, $55/unit installed.
